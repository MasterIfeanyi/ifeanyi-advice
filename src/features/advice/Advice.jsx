        ...
        <div className="row d-flex justify-content-center align-items-center">
          <div className="col-md-6">
            <div className="advice text-center flexing">
              {isError && (<p data-testid="test-error-content" className="fw-bold text-danger leads">
                  {error.error}
                </p>) }
              {isSuccess && (
                <p data-testid="test-advice-content" className="leads fw-bold text-light">{advice}</p>
              )}
                        {isLoading && (
